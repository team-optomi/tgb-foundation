...
const GlowPageDetroit = ({ data: { queryContent, cityContent } }) => {
    ...
    return(
        <Layout>
            <Seo 
            title={'TGB Day Run Walk - Detroit'} 
...
export default GlowPageDetroit
...
export const pageQuery = graphql`
    query {
        ...
        cityContent: wpPage(databaseId: {eq: 1803}) {
            title
            content
            tgbDayCityTemplate {
                cityDonorboxEmbed
