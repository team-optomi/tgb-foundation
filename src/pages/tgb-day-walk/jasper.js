...
const GlowPageJasper = ({ data: { queryContent, cityContent } }) => {
...
export const pageQuery = graphql`
    query {
        ...
        cityContent: wpPage(databaseId: {eq: 2374}) {
            title
            content
            tgbDayCityTemplate {
                cityDonorboxEmbed
