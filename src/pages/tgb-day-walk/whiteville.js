...
const GlowPageWhiteville = ({ data: { queryContent, cityContent } }) => {
    ...
    return(
        <Layout>
            <Seo 
            title={'TGB Day Run Walk - Whiteville'} 
...
export default GlowPageWhiteville
...
export const pageQuery = graphql`
    query {
        ...
        cityContent: wpPage(databaseId: {eq: 3568}) {
            title
            content
            tgbDayCityTemplate {
                cityDonorboxEmbed
