...
const GlowPageTahlequah = ({ data: { queryContent, cityContent } }) => {
    ...
    return(
        <Layout>
            <Seo 
            title={'TGB Day Run Walk - Tahlequah'} 
...
export default GlowPageTahlequah
...
export const pageQuery = graphql`
    query {
        ...
        cityContent: wpPage(databaseId: {eq: 2376}) {
            title
            content
            tgbDayCityTemplate {
                cityDonorboxEmbed
