...
const DallasPage = ({ data: { queryContent } }) => {
    ...
    return(
        <Layout>
            ...
            <FooterSection>
                <div class="form-row">
                    <form name="Dallas Email" method="POST" netlify-honeypot="bot-field" action="/thank-you/" data-netlify="true">
                        <input type="hidden" name="form-name" value="Dallas Email" aria-label="Input"/>
                        <div class="flex-row">
                            <div class="col-full">
...
export const pageQuery = graphql`
    query {
        queryContent: wpCity(databaseId: {eq: 459}) {
            title
            content
            featuredImage {
                node {
