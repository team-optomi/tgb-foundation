...
const JasperPage = ({ data: { queryContent } }) => {
    ...
    return(
        <Layout>
            ...
            <FooterSection>
                <div class="form-row">
                    <form name="Jasper Email" method="POST" netlify-honeypot="bot-field" action="/thank-you/" data-netlify="true">
                        <input type="hidden" name="form-name" value="Jasper Email" aria-label="Input"/>
                        <div class="flex-row">
                            <div class="col-full">
...
export default JasperPage

export const pageQuery = graphql`
    query {
        queryContent: wpCity(databaseId: {eq: 786}) {
            title
            content
            featuredImage {
                node {
